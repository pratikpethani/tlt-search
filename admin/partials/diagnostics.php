...
<div class="wrap">
	...
	<!-- System Requirements -->
	<h2><?php esc_html_e( 'System Requirements', 'tlt-search' ); ?></h2>
	<table class="widefat striped" style="max-width:640px;margin-bottom:2em;">
		<thead>
			<tr>
	...
	<!-- Index Information -->
	<h2><?php esc_html_e( 'Index Information', 'tlt-search' ); ?></h2>
	<table class="widefat striped" style="max-width:640px;margin-bottom:2em;">
		<tbody>
			<tr>
	...
	<!-- WP-Cron Status -->
	<h2><?php esc_html_e( 'WP-Cron Status', 'tlt-search' ); ?></h2>
	<table class="widefat striped" style="max-width:640px;margin-bottom:2em;">
		<tbody>
			<tr>
